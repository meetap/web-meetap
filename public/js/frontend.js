            ...
            success: function (result) {
                ...
                result.data.forEach(function (item, index) {
                    ...
                    $("#cartBtn").append(
                        '<a href="' +
                            crUrl +
                            '" class="theme-btn cart-btn cart-text">' +
                            crname +
                            "</a>"
                    );
                    ...
                    $(".love-" + item.course_id).prop("href", "javascript:;");
                    ...
                    html +=
                        '<li><div class="cart-item"><div class="m-3"><div class="row"><div class="col-md-3 my-auto"><a href="' +
                        item.link +
                        '" target="_blank">' +
                        '<img src="' +
                        item.image +
                        '" alt="' +
                        item.title +
                        '" class="avatar-lg rounded-circle"></a></div>' +
                        '<div class="col-md-9 my-auto"><div class="item__info"><p class="item__info-link">' +
                        '<a href="' +
                        item.link +
                        '" target="_blank" class="f-18">' +
                        item.title +
                        '</a></p><span class="item__price theme-color">' +
                        item.price +
                        "</span>" +
...
function notifySidebaropenNav() {
    document.getElementById("notifySidebar").style.right = "0";
}

function notifySidebarcloseNav() {
    document.getElementById("notifySidebar").style.right = "-100%";
}
...
function wishcloseNav() {
    document.getElementById("wishSidebar").style.right = "-100%";
}

// /*search*/
// $('#header_inputBox').on('keyup', function () {
