                                    ...
                                    <div class="notification-wrap d-flex align-items-center ml-3">
                                        <div class="notification-item mr-3 cart_item">
                                            <button class="notification-btn" type="button" onclick="openNav()"
                                                ...
                                                <span class="quantity cart-quantity">{{ App\Models\Cart::where('user_id',Auth::user()->id)->count() }}</span>
                                            </button>
                                        ...
                                        <div class="notification-item mr-3 notify_btn">
                                            ...
                                            <button class="notification-btn" type="button"
                                                ...
                                                <span class="quantity">{{ App\Models\NotificationUser::where('user_id',Auth::user()->id)->where('is_read',false)->count() }}</span>
                                            </button>
                                            ...
                                            <div id="notifySidebar" class="cart-sidebar">
                                                ...
                                                <div class="cart_sidebar">
                                                    ...
                                                    <ul class="list-group">
                                                        ...
                                                        <li>
                                                            @forelse (App\Models\NotificationUser::where('user_id',Auth::user()->id)->where('is_read',false)->latest()->get() as $notification)
...
<ul class="nav justify-content-center fixed-bottom bg-white btm-fixed-nav d-none">
  ...
  <li class="nav-item">
    <div class="notification-item mr-3">
      ...
      <button class="notification-btn dropdown-toggle">
        <i class="la la-heart-o"></i>
          <span class="quantity wishlist-quantity">{{ App\Models\Wishlist::where('user_id',Auth::user()->id)->count() }}</span>
      </button>
    </a>
    </div>
  </li>
