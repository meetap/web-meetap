                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="our-post-item">
                                                    ...
                                                    <div class="our__text">
                                                        <h4 class="widget-title">{{number_format(\App\Models\Course::Published()->where('is_published',true)->count())}}
   ...
   ======================================-->
    ...
    <section class="category-area padding-bottom-90px padding-top-90px">
        <div class="container">
            ...
            <div class="category-wrapper margin-top-28">
                <div class="row">
    ...
    <section class="course-area">
        <div class="course-wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-tab margin-top-28 margin-bottom-55">
                                    ...
                                    <div class="card-item card-preview"
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="rating-wrap d-flex mt-2 mb-3">
                                                        <span class="star-rating-wrap">
                                                         @translate(Enrolled) <span
                                                                class="star__count">{{\App\Models\Enrollment::where('course_id',$t_courses->id)->count()}}</span>
                                                      </span>
                                            </div><!-- end rating-wrap -->
                                            <div class="card-action">
                                                <ul class="card-duration d-flex justify-content-between align-items-center">
            ...
            <div class="row">
                <div class="col-lg-3 column-td-half">
                    <div class="counter-item">
                        ...
                        <h4 class="count__title text-color-2 count-up" data-from="0" data-to="{{\App\Models\User::where('user_type','Instructor')->get()->count()}}" data-time="1000">0</h4>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="counter-item">
                        ...
                        <h4 class="count__title  count__title text-color-2 count-up1" data-from="0" data-to="{{\App\Models\User::where('user_type','Student')->get()->count()}}" data-time="1000">0</h4>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="counter-item">
                        ...
                        <h4 class="count__title  count__title text-color-2 count-up2" data-from="0" data-to="{{\App\Models\Enrollment::count()}}" data-time="1000">0</h4>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="counter-item">
                        ...
                        <h4 class="count__title count__title text-color-2 count-up3" data-from="0" data-to="{{\App\Models\Course::Published()->count()}}" data-time="1000" >0</h4>
